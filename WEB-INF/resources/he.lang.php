...
"controls.per_ty" => 'שנה זו',
"controls.sel_period" => '--- בחר תקופת זמן ---',
"controls.sel_groupby" => '--- ללא הקבצה ---',
...
"controls.select.location" => '--- בחר מיקום ---',
...
"label.painfo" => ' (אדמיניסטרטור)',
"label.time_noentry" => 'אין רשומות',
"label.today" => 'היום',
"label.req_fields" => '* שדות חובה',
"label.sel_project" => 'בחר פרוייקט',
"label.sel_activity" => 'בחר פעילות',
"label.sel_tp" => 'בחר תקופת זמן',
"label.set_tp" => 'או הגדר ימים',
"label.fields" => 'הצג שדות',
"label.group_title" => 'הקבצה',
"label.include_title" => 'כלול רשומות',
"label.inv_str" => 'חשבונית',
"label.set_empl" => 'בחר משתמשים',
"label.sel_all" => 'בחר הכל',
"label.sel_none" => 'הסר הכל',
"label.or" => 'או',
...
'form.reports.approved' => 'הצג רק לא מאושרים',
